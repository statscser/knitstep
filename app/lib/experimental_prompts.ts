/**
 * Experimental AI grid-parsing prompts.
 * These are kept for reference / future research but are not used in the
 * main production UI (which now uses manual calibration + row tracking).
 */
